    ...
    public void send(User user, Message message) {
        ...
        MimeMessagePreparator preparator = mimeMessage -> {
            ...
            String htmlText = "<html><body>" +
                    ...
                    "<p>Программа: " + theme + "</p>" +
                    "<br><p>Анкету и заявление Вы можете скачать их из этого письма. Их необходимо распечатать и подписать. <u>ВАЖНО!!! Заявление должны подписать в дирекции Вашего института и преподаватель по дисциплине. Подписанные документы необходимо сдать в ауд. Ж-217 Климовой М.А.</u></p>" +
